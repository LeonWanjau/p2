...
Scheduler.plugin(function (e) {
    e.config.occurrence_timestamp_in_utc = !1, e.config.recurring_workdays = [1, 2, 3, 4, 5], e.form_blocks.recurring = {
            ...
            _init_set_value: function (t, a, n) {
                ...
                function r() {
                    y("dhx_repeat_day").style.display = "none", y("dhx_repeat_week").style.display = "none", y("dhx_repeat_month").style.display = "none", y("dhx_repeat_year").style.display = "none", y("dhx_repeat_" + this.value).style.display = "block", e.setLightboxSize()
                }
                ...
                function o(t) {
                    ...
                    else if ("date_of_end" == i) t.end = g(c(p, "date_of_end"));
                    else {
                ...
                function s(t, a) {
                    ...
                    switch (t = i[0].split("_"), x[t[0]](t, a), i[1]) {
                        ...
                        case "":
                            ...
                            break;
                        default:
                            d(p, "occurences_count"), n(p, "occurences_count", i[1])
                    }
                    n(p, "repeat", t[0]);
                ...
                var u = e.date.str_to_date(e.config.repeat_date),
                    ...
                    p = {};
                if (i(v.getElementsByTagName("INPUT")), i(v.getElementsByTagName("SELECT")),
                ...
                var b = {
                        month: function (t, a) {
                            ...
                            "d" == n(p, "month_type") ? (t.push(Math.max(1, i(p, "month_count"))),
                                a.start.setDate(n(p, "month_day"))) : (t.push(Math.max(1, i(p, "month_count2"))), t.push(n(p, "month_day2")), t.push(Math.max(1, i(p, "month_week2"))), e.config.repeat_precise || a.start.setDate(1)), a._start = !0
                        },
                        week: function (t, a) {
                            var n = e.form_blocks.recurring._get_node_value,
                                i = e.form_blocks.recurring._get_node_numeric_value;
                            t.push(Math.max(1, i(p, "week_count"))), t.push(""), t.push("");
                            for (var r = [], o = n(p, "week_day", !0), _ = a.start.getDay(), d = !1, s = 0; s < o.length; s++) r.push(o[s]), d = d || o[s] == _;
                            r.length || (r.push(_),
                                d = !0), r.sort(), e.config.repeat_precise ? d || (e.transpose_day_week(a.start, r, 1, 7), a._start = !0) : (a.start = e.date.week_start(a.start), a._start = !0), t.push(r.join(","))
                        },
                        day: function (t) {
                    ...
                    x = {
                        ...
                        year: function (t, a) {
                            var n = e.form_blocks.recurring._set_node_value;
                            "" === t[2] ? (n(p, "year_type", "d"), n(p, "year_day", a.start.getDate()),
                                n(p, "year_month", a.start.getMonth())) : (n(p, "year_type", "w"), n(p, "year_week2", t[3]), n(p, "year_day2", t[2]), n(p, "year_month2", a.start.getMonth()))
                        }
                    };
            ...
            set_value: function (t, a, n) {
                ...
                e._lightbox._rec_init_done || i._init_set_value(t, a, n), t.open = !n.rec_type,
                    t.blocked = this._is_modified_occurence(n);
                var r = i._ds;
                r.start = n.start_date, r.end = n._end_date, i._toggle_block(), a && i._set_repeat_code(a, r)
            },
            get_value: function (t, a) {
                if (t.open) {
                    var n = e.form_blocks.recurring._ds,
                        i = {};
                    this.formSection("time").getValue(i), n.start = i.start_date, a.rec_type = e.form_blocks.recurring._get_repeat_code(n), n._start ? (a.start_date = new Date(n.start), a._start_date = new Date(n.start), n._start = !1) : a._start_date = null, a._end_date = n.end, a.rec_pattern = a.rec_type.split("#")[0]
        ...
        }, e._rec_markers = {}, e._rec_markers_pull = {},
        ...
        function () {
            ...
            e.addEvent = function (a, n, i, r, o) {
                ...
                if (_ && e.getEvent(_)) {
                    var d = e.getEvent(_);
                    this._is_modified_occurence(d) && e._add_rec_marker(d, 1e3 * d.event_length), d.rec_type && (d.rec_pattern = d.rec_type.split("#")[0])
                }
                return _
            }
            ...
            if (this._is_virtual_event(e) || this._is_modified_occurence(t) && t.rec_type && "none" != t.rec_type) {
                ...
                for (var _ in o) o.hasOwnProperty(_) && (e = o[_].id, this.getEvent(e) && this.deleteEvent(e, !0))
            }
            return !0
            ...
            if (this._is_virtual_event(e)) {
                ...
                i.id = n, i.event_pid = e[0];
                var r = e[1];
                i.event_length = r, i.rec_type = i.rec_pattern = "", this._add_rec_marker(i, 1e3 * r),
                    this.addEvent(i), this._not_render = !1
            } else {
                a.rec_type && this._lightbox_id && this._roll_back_dates(a);
                var o = this._get_rec_markers(e);
                for (var _ in o) o.hasOwnProperty(_) && (delete this._rec_markers[o[_].id], this.deleteEvent(o[_].id, !0));
            ...
            return this.getEvent(e).rec_type || !t.rec_type || this._is_virtual_event(e) || (this._select_id = null), !0
        ...
        function () {
            ...
            for (var o = (t.getDay() || (e.config.start_on_monday ? 7 : 0)) - n, _ = 0; _ < a.length; _++)
                if (a[_] > o) return t.setDate(t.getDate() + 1 * a[_] - o - (i ? n : r));
            ...
            if (!this.date[a]) {
                ...
                if ("day" == n[0] || "week" == n[0]) {
                    var o = null;
                    if (n[4] && (o = n[4].split(","), e.config.start_on_monday)) {
                        for (var _ = 0; _ < o.length; _++) o[_] = 1 * o[_] || 7;
                        o.sort()
                    }
                    this.date[a] = function (t, a) {
                        var n = Math.floor((a.valueOf() - t.valueOf()) / (864e5 * r));
                        n > 0 && t.setDate(t.getDate() + n * r), o && e.transpose_day_week(t, o, 1, r)
                    }, this.date[i] = function (t, a) {
                        var n = new Date(t.valueOf());
                        if (o)
                            for (var i = 0; i < a; i++) e.transpose_day_week(n, o, 0, r);
                    ...
                    i >= 0 && t.setMonth(t.getMonth() + i * r), n[3] && e.date.day_week(t, n[2], n[3])
                }, this.date[i] = function (t, a) {
                    var i = new Date(t.valueOf());
                    return i.setMonth(i.getMonth() + a * r), n[3] && e.date.day_week(i, n[2], n[3]), i
                })
            }
        },
        e.repeat_date = function (t, a, n, i, r, o) {
            i = i || this._min_date, r = r || this._max_date;
            var _ = o || -1,
                d = new Date(t.start_date.valueOf()),
                s = d.getHours(),
                l = 0;
            for (!t.rec_pattern && t.rec_type && (t.rec_pattern = t.rec_type.split("#")[0]), this.transpose_type(t.rec_pattern), e.date["transpose_" + t.rec_pattern](d, i); d < t.start_date || e._fix_daylight_saving_date(d, i, t, d, new Date(d.valueOf() + 1e3 * t.event_length)).valueOf() <= i.valueOf() || d.valueOf() + 1e3 * t.event_length <= i.valueOf();) d = this.date.add(d, 1, t.rec_pattern);
            for (; d < r && d < t.end_date && (_ < 0 || l < _);) {
                ...
                if (h) n && ("none" != h.rec_type && l++, a.push(h));
                    ...
                    if (g.text = t.text, g.start_date = d, g.event_pid = t.id, g.id = t.id + "#" + Math.ceil(c / 1e3), g.end_date = u,
                        g.end_date = e._fix_daylight_saving_date(g.start_date, g.end_date, t, d, g.end_date), g._timed = this.isOneDayEvent(g), !g._timed && !this._table_view && !this.config.multi_day) return;
                    a.push(g), n || (this._events[g.id] = g, this._rec_temp.push(g)), l++
                }
