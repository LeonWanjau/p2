...
$(document).ready(function () {
    ...
    var editor = new $.fn.dataTable.Editor({
        ajax: 'http://localhost/IS_P2/public/index.php/messages/teachers/sent/action',
        table: '#table_id',
        idSrc: 'id',
        fields: [{
                label: 'ID',
    ...
    var table = $('#table_id').DataTable({
        ...
        ajax: {
            url: 'http://localhost/IS_P2/public/index.php/messages/teachers/sent/view',
            type: 'POST',
            dataSrc: 'data'
        },
    ...
    function format(callback, msg_id) {
        ...
        $.ajax({
            ...
            url: "http://localhost/IS_P2/public/index.php/messages/teachers/sent/associated_teachers",
